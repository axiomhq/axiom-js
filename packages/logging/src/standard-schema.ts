/**
 * Minimal Standard Schema v1 type definitions.
 *
 * These are structural so users can pass schemas from any validator library
 * implementing the spec without adding a runtime dependency here.
 */
